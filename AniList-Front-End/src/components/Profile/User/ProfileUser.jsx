  ...
  return (
    <div className='Page_Content'>
        <div className='header_wrap'>
            ...
            style={{ backgroundImage: bannerSrc!=='null' ? `url(http://localhost:8080/api/auth/usuarios/`+userId+`/banner_picture)` : 'none' }}
            >
                <div className='shadow'></div>
                <div className='container'>
                    <div className='banner_container'>
                        <img src={idImage !== 'null' ? 'http://localhost:8080/api/auth/usuarios/'+userId+'/profile_picture': require('../../images/profile/profile.png')} className='avatar' alt="profile" />
